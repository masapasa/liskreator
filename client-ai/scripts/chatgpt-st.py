...
if response:
    ...
    if st.button("Summarize"):
        ...
        st.write(answer)
answer = st.text_input("Enter your prompt", value = "intricate detailed artwork of astronauts using dj controller playing techno house music, in the style of Moebius, wires, speakers, black and white ink, some ink drips")
